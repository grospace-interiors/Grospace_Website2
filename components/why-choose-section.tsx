...
export function WhyGrospaceInteriors() {
  ...
  return (
    <section className="w-full overflow-hidden bg-[#fdfdfd] py-16 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        <div className="mb-12 space-y-4 text-center sm:mb-20">
          <h2 className="text-3xl font-serif font-light leading-tight tracking-tight text-[#2d1b4e] sm:text-4xl lg:text-6xl">
        ...
        <div className="-mx-4 flex snap-x snap-mandatory gap-4 overflow-x-auto px-4 pb-4 no-scrollbar md:mx-0 md:grid md:grid-cols-2 md:gap-5 md:overflow-visible md:px-0 md:pb-0 lg:grid-cols-3 lg:gap-12">
          {reasons.map((reason, index) => (
            <div 
              key={index} 
              className="group min-w-[84%] snap-center rounded-3xl border border-zinc-100 bg-white p-6 transition-all duration-500 hover:border-[#ee6669]/20 hover:shadow-2xl md:min-w-0 sm:p-10 sm:rounded-[2.5rem]"
            >
