...
import { CheckCircle2, Droplets, Shield, Zap, Sparkles, Sliders, Maximize, Gauge } from 'lucide-react'
              ...
              >
                <div className="flex flex-col md:flex-row gap-8">
                  <div className="w-16 h-16 rounded-2xl bg-zinc-50 flex items-center justify-center group-hover:bg-[#ee6669]/10 transition-colors duration-500 shrink-0">
                    <item.icon className="w-8 h-8 text-zinc-400 group-hover:text-[#ee6669] transition-colors duration-500" />
                  </div>
